...
Pour rendre l'application fermée à la modification, nous avons utilisé l'instanciation dynamique via la réflexion Java (`Class.forName()`) et un fichier de configuration externe.
